			...
			<%@include file="left.jsp"%>
				...
				<div class="rtcont fr">
					...
					<div class="subgrzl ml40">
						<span>收货人</span> <span> 
						<input id="customer_id" type="hidden" value="${customerDeveInfo.id }"/>
						<input id="acceptor_name"
							type="text" placeholder="请输入收货人姓名" /></span>
					</div>
					<div class="subgrzl ml40">
						<span>电话/手机</span> <span><input type="text"
					...
					<div class="subgrzl ml40">
						<span>详细地址</span><span><input type="text" id="street"
